...
public class OakStrainerFrameGUI extends StrainerFrameGUI<OakStrainerFrameMenu> {
    public OakStrainerFrameGUI(OakStrainerFrameMenu menu, Inventory playerInventory, Component title) {
